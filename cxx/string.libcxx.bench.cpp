...
BENCHMARK(BM_CStringFindAllMatch)->Range(1, MAX_STRING_LEN);
...
BENCHMARK(BM_CStringFindMatch1)->Range(1, MAX_STRING_LEN / 4);
...
BENCHMARK(BM_CStringFindMatch2)->Range(1, MAX_STRING_LEN / 4);
